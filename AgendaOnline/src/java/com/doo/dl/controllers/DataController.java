...
//               String materiaAlumno = request.getParameter("materia");
//               DataPOJO dto1 = new DataPOJO();
//               dto1.setMateria(materiaAlumno);
//               ArrayList<DataPOJO> deberes1 = dao.buscarAlumno(dto1);
//               session.setAttribute("Deberes1", deberes1);
