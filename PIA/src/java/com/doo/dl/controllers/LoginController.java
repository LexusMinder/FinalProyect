...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isValid = Authenticate.isValid(txtUsername, txtPassword, autorizacion);
        if(action.equals("LoginMaestro")){   
            if (isValid == true){
                ...
                response.sendRedirect("ProfileMaestro.jsp");
                 ...
                 out.print("<font color='red'><b>La usuario o password introducido es erroneo o no es maestro. Porfavor intente de nuevo</b></font>");
        ...
        if(action.equals("LoginAlumno"))
            if (isValid == true){
                ...
                response.sendRedirect("ProfileAlumno.jsp");
                 ...
                 rd.include(request, response);
                 out.print("<font color='red'><b>La usuario o password introducido es erroneo o no es alumno. Porfavor intente de nuevo</b></font>");
